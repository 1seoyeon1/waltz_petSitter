...
<div class="sec-if">
       ...
       <div class="con">
          ...
          <input class="form-control" type="tel" id="user_phone" name="user_phone" value="${mprofile.user_phone}" readonly="readonly"/>
       </div>
   
       
       <div class="btn-wrap">
          <button class="btns" type="button" id="update" >수정하기</button>
          <button class="btns" type="button"  id="delete" >회원 탈퇴</button>
          <button class="btns" type="button" id="cancel" >홈페이지로 이동</button>       
       </div>
