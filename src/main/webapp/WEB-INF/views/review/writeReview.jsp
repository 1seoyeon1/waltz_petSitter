...
<div id="root">
	<section id="container">
		...
		<form name="writeForm" method="post" action="/review/writeReview" enctype="multipart/form-data" class="whole-form">
			...
			<div class="all_star">
				<input type="checkbox" id="r_rate1" class="star" onclick="check1();" />&nbsp;&nbsp;
				<input type="checkbox" id="r_rate2" class="star" onclick="check2();"/>&nbsp;&nbsp;
				<input type="checkbox" id="r_rate3" class="star" onclick="check3();"/>&nbsp;&nbsp;
				<input type="checkbox" id="r_rate4" class="star" onclick="check4();"/>&nbsp;&nbsp;
				<input type="checkbox" id="r_rate5" class="star" onclick="check5();"/>
			</div>			
