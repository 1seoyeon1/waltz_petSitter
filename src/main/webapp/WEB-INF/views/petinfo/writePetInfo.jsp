...
<div class="sec-if">
    ...
    <form action="/petinfo/infowrite" method="post" enctype="multipart/form-data">
       ...
       <div class="con">
          ...
          <input class="form-control" type="number" id="pet_age" name="pet_age"/>
       </div>
       ...
       <div class="btn-wrap">
          <button  class="btns1" type="submit" id="submit_btn">펫 정 보 작 성 완 료 </button>
          <button class="btns2" id="cancel" type="button">목록으로 이동</button>       
       </div>
