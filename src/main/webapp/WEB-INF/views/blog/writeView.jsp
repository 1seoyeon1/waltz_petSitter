      ...
      <div class="whole-content">
         <form name="writeForm" method="post" action="/blog/write" enctype="multipart/form-data" class="whole-form">
            <c:if test="${sessionScope.member != null }">
               <input type="hidden" name="blog_memail" class="chk" value="${sessionScope.member}"  />
               <input type="hidden" name="blog_semail" class="chk" value=""  />
               </c:if>
               <c:if test="${sessionScope.sitter != null }">
               <input type="hidden" name="blog_semail" class="chk" value="${sessionScope.sitter}" />
               <input type="hidden" name="blog_memail" class="chk" value="" />
               </c:if>
				...
				<label for="file">파일찾기</label>
                 ...
                 <div>
				<select class="category-input" name="blog_category" class="form-control"> 
					<option selected value>카테고리를 선택하세요.</option>
					<option value="일상">일상</option>
					<option value="마이펫">마이펫</option>
					<option value="상식">상식</option>
					<option value="놀이터">놀이터</option>
					<option value="펫용품">펫용품</option>
				</select>
				</div> 
				</div>
