...
<div class="rqlist">
<div class="headpt">
<span style="margin-left:50px;">제목</span><span style="margin-left: 40px;">보낸사람</span><span style="margin-left: 30px;">요청일</span><span style="margin-left: 50px;margin-right: 20px;">읽음</span><span style="margin-right: 20px;">처리상태</span>
</div>
<div class="conlist">
