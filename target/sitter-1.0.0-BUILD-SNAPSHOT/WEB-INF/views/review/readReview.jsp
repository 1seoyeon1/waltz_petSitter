...
<div class="read-content">
	...
	<div>
		...
		<label for="ruse_date">이용 날짜 : </label>
		<input style="border:none" type="text" id="ruse_date" name="ruse_date" value="${read.ruse_date}" readonly="readonly"/>
		</div>
	...
	<div class="review-write-date">
		<label for="rwrite_date">작성일 : </label>
		<fmt:formatDate value="${read.rwrite_date}" pattern="yyyy-MM-dd"/>
	</div>
	
	<div class="review-user_email">
		<label for="user_email">작성자 아이디 : </label>
		<input style="border:none" type="text" id="user_email" name="user_email" value="${read.user_email}" readonly="readonly"/>
	</div>
		<div class="content-space"></div>
	<div>
