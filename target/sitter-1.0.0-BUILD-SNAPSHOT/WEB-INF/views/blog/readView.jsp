...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      // 댓글 수정 View
      $(".replyUpdate-Btn").on("click", function() {
   ...
   <div class="col-md-8">
	...
	<div class="full-detail-content">
      ...
      <div class="blog-meta">
         ...
         <span class="blog-meta_texts"><c:out value="${read.blog_email}"/></span>
      </div>
      ...
      <div class="form-group">
         <form method="post" name="likeForm" class="like-area">
         <input type="hidden" id="likeBlog_bno" name="likeBlog_bno" value="${read.blog_bno}" />
         <c:choose>
         <c:when test="${likeResult eq '0' or empty likeResult}">
         <img src="/resources/images/empty.png" class="likebtn" style="cursor:pointer; width: 40px;">
         </c:when>
         <c:otherwise>
         <img src="/resources/images/full.png" class="likebtn" style="cursor: pointer; width:40px;">
         </c:otherwise>
         </c:choose> 
